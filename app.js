...
const focusMvpsListEl = document.querySelector("#straubinger-mvps-list");
...
const focusTeam = "NawaRo Straubing";
  ...
  games
    ...
    .forEach(game => {
      ...
      if (game.videoUrl) {
        ...
        videoLink.href = "https://www.youtube.com/results?search_query=NawaRo+Straubing+2.+Liga+Pro+2025%2F26";
        videoLink.classList.remove("disabled");
        videoLink.textContent = "YouTube Suche";
      }
...
function renderRankChart() {
  ...
  const svg = make("svg", {
    ...
    role: "img",
    "aria-label": "Tabellenplatz von NawaRo Straubing nach jedem Spieltag"
  });
